# Generated by Powerlevel10k configuration wizard on 2024-08-16 at 10:26 CDT.
...
() {
  ...
  # Custom icon.
  # Note: p10k's context segment hardcodes an empty icon parameter, so
  # VISUAL_IDENTIFIER_EXPANSION has no effect here (p10k source limitation).
  ...
  typeset -g POWERLEVEL9K_TERRAFORM_VISUAL_IDENTIFIER_EXPANSION=$'\U000F1062'
