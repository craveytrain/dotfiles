# Generated by Powerlevel10k configuration wizard on 2019-07-29 at 16:48 CDT.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 21472.
# Wizard options: nerdfont-complete, big icons, many icons, concise, 2 lines, disconnected, no frame, sparse.
#
...
() {
  ...
  vcs+='${${VCS_STATUS_NUM_UNSTAGED:#0}:+ %10F!${VCS_STATUS_NUM_UNSTAGED}}'
  # ?42 if have untracked files.
  vcs+='${${VCS_STATUS_NUM_UNTRACKED:#0}:+ %6F?${VCS_STATUS_NUM_UNTRACKED}}'
